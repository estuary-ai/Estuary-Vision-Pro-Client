...
//         Seating,  // walking on floor and jumping onto chair
...
//         // }
//
//         if((navState == NavState.Walking || navState == NavState.Seating) && Vector3.Distance(navMeshAgent.gameObject.transform.position, navMeshAgent.destination) <= 0.2f)
//         {
...
//     {
//         lastFloorPos = navMeshAgent.gameObject.transform.parent.position;
...
//         var targetPosition = seatPos;
//
//         var stepSize = 0.9f;
//         var arcHeight = 0.5f;
//         arcHeight = arcHeight * Vector3.Distance(startPosition, targetPosition);
//
//         var objectToMove = navMeshAgent.gameObject.transform.parent;
//
//         StartCoroutine(parabolaMove(startPosition, targetPosition, objectToMove, stepSize, arcHeight));
//
...
//     }
//
//     private IEnumerator MoveAgentDownFromSeatThenMove(Vector3 destCoords)
//     {
...
//         navState = NavState.Standing;
//
//         MakeNavigate(destCoords);
//
//         yield return null;
//     }
//
//     private IEnumerator MoveAgentDownFromSeatThenMove(GameObject destNode)
//     {
//         // jump down to lastFloorPos
//         var startPosition = navMeshAgent.gameObject.transform.parent.position;
//         var targetPosition = lastFloorPos;
...
//         navState = NavState.Standing;
//
//         MakeNavigate(destNode);
//
//         yield return null;
//     }
//
//     private IEnumerator parabolaMove(Vector3 startPosition, Vector3 targetPosition, Transform objectToMove, float stepSize, float arcHeight)
//     {
//         var progress = 0f;
//         var arrived = false;
//         while (!arrived)
